...
<body>
	...
	<main>
				...
				<div class=" central col l8">
					...
					<blockquote class="instagram-media center-align" data-instgrm-captioned data-instgrm-permalink="https://www.instagram.com/p/Bjvt_CcBMRK/" data-instgrm-version="8" style=" background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:658px; padding:0; width:99.375%; width:-webkit-calc(100% - 2px); width:calc(100% - 2px);">
						<div style="padding:8px;">
							...
							<p style=" margin:8px 0 0 0; padding:0 4px;"><a href="https://www.instagram.com/p/Bjvt_CcBMRK/" style=" color:#000; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:normal; line-height:17px; text-decoration:none; word-wrap:break-word;" target="_blank">Reativei o Instagram para fazer o trabalho da disciplina de sistemas web 3</a></p> 
		...
		<a href="link.html" class="novo-post waves-effect purple darken-4 btn"><i class="material-icons right">assignment_ind</i>Nova Postagem</a>
	</main>
	<footer>
